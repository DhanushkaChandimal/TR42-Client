                        ...
                        <div>
                            ...
                            <div className="mt-5 pt-lg-4">
                                ...
                                <h1 className="login-hero-title fw-semibold mb-4">
                                    Sign in to monitor vendors, fraud risk, and
                                    service delivery.
                                </h1>
                                <p className="login-hero-text mb-4">
                                    Access the client control surface for vendor
                                    approval, compliance monitoring, invoice
                                    review, and anomaly analytics.
                                </p>

                                <div className="login-preview-carousel">
                                    <div className="login-preview-track">
                                        {[...previewCards, ...previewCards].map(
                                            (card, i) => (
                                                <div
                                                    key={i}
                                                    className="login-preview-card"
                                                >
                                                    <p className="login-preview-card-label">
                                                        {card.label}
                                                    </p>
                                                    <p className="login-preview-card-value">
                                                        {card.value}
                                                    </p>
                                                    <p className="login-preview-card-trend">
                                                        {card.trend}
                                                    </p>
                                                </div>
                                            ),
                        ...
                        <div className="login-panel w-100 shadow-lg">
                            <div className="mb-4">
                                ...
                                <p className="login-panel-text">
                                    Sign in with your client operator account to
